...
public class Course {
    ...
    public Course(int courseID, String courseGrade, String courseTitle, int courseDivid, int coursePersonnel, int courseRival) {
        this.courseID = courseID;
        this.courseGrade = courseGrade;
        this.courseTitle = courseTitle;
        this.courseDivid = courseDivid;
        this.coursePersonnel = coursePersonnel;
        this.courseRival = courseRival;
    }

    public Course(int courseID, String courseGrade, String courseTitle, int courseDivid, int coursePersonnel, int courseRival, int courseCredit) {
        this.courseID = courseID;
        this.courseGrade = courseGrade;
        this.courseTitle = courseTitle;
        this.courseDivid = courseDivid;
    ...
    public Course(int courseID, String courseGrade, String courseTitle, int courseCredit, int courseDivid, int coursePersonnel, String courseTime, String courseProfessor) {
        this.courseID = courseID;
        this.courseGrade = courseGrade;
        this.courseTitle = courseTitle;
        this.courseCredit = courseCredit;
    ...
    public Course(int courseID, String courseUniversity, int courseYear, String courseTerm, String courseArea,
                  String courseMajor, String courseGrade, String courseTitle, int courseCredit, int courseDivid,
    ...
    public int getCourseDivid() {
        return courseDivid;
    }

    public void setCourseDivid(int courseDivid) {
        this.courseDivid = courseDivid;
    }
